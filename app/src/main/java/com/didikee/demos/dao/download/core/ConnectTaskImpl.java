...
import com.didikee.demos.dao.download.Constants;
...
public class ConnectTaskImpl implements ConnectTask {
    ...
    private void executeConnection() throws DownloadException {
        ...
        try {
            ...
            if (checkRedirect(httpConnection)){
                return;
            }
    ...
    private boolean checkRedirect(HttpURLConnection httpConnection) {
        String location = httpConnection.getHeaderField("Location");
        Log.e("test","redirect location: "+location);
        if (!TextUtils.isEmpty(location)){
            if (location.equalsIgnoreCase(mUri)){
                //do nothing
                return false;
            }else {
                try {
